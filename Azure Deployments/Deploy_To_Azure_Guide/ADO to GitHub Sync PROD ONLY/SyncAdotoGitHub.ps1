...
Write-Host ' - - - - - - - - - - - - - - - - - - - - - - - - - '
$AzureRepoName = "<RepoName>"
$ADOCloneURL = "dev.azure.com/<OrganisationName>/<ProjectName>/_git/<RepoName>"
$GitHubCloneURL = "github.com/<GitHubAccount>/<RepoName>"
